...
namespace Worktastic.Controllers
{
    public class HomeController : Controller
    {
        ...
        public IActionResult GetJobPosting(int id)
        {
            ...
            var jobPostingsFromDb = _context.JobPostings.SingleOrDefault(x => x.Id == id);

            if (jobPostingsFromDb == null)
            {
                return NotFound();
            }
            return Ok(jobPostingsFromDb);
        }
        ...
        public IActionResult GetJobPostingsPartial(string query)
        {
            ...
            return PartialView("_JobPostingsListPartial", jobPostings);
        }
    }
}